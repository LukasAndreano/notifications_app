      ...
      {!loader ? (
        <Fragment>
          <Placeholder style={{ marginTop: -20, marginBottom: -35 }}>
            Уведомления от сообщества будут приходить Вам в личные сообщения, а
            от сервиса в «колокольчик» (раздел уведомлений).
          </Placeholder>
          <Cell
            onClick={() => {
              if (!blockSwitch) {
          ...
          {storage.notifications === 1 && (
            <Div>
              ...
              <Placeholder style={{ marginTop: -30, marginBottom: -20 }}>
                Выберите время, когда Вы хотите получать уведомления от сервиса
                в «колокольчик» и в личные сообщения. Если выбрать два
                одинаковых параметра, то настройка отключится. Часовой пояс:
                GMT+3.
              </Placeholder>
            </Div>
          )}
